      ...
      <div className="grid lg:grid-cols-2 gap-16 lg:gap-24">
        ...
        <div>
          ...
          <ScrollReveal delay={700}>
            <div className="mt-12">
              <a href="/Mitty (XiaoYu) Huang Product Designer - CV.pdf" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 font-mono text-sm font-medium text-accent 
